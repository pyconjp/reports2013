...
私は台湾に行くのは、昨年の PyCon Taiwan 2012 に続いて2回目です。
...
夜は `青葉`_ という有名な台湾料理のレストランに、日本からPyCon Taiwanに参加するPyCon JPメンバーと、今回PyCon Taiwanの `スポンサー <http://tw.pycon.org/2013/ja/sponsors/>`_ にもなっている `(株)Catchball21`_ (以下CB21)のメンバーが集合し夕食をとりました。

青葉は台湾でも有名なレストランで、日本人観光客も多いため日本語メニューもあり店員との会話も日本語が使えました。当日の昼過ぎに店にSkype電話で予約したのですが、このときも日本語で大丈夫でした。青葉に限らず、台湾ではかなりの場所で日本語を見聞きしましたが、タクシーでは日本語が通じたことが無いので、あまり日本語が使えることを期待しすぎても困ることがありそうですね。
