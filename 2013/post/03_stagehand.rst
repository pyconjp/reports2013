...
また大学側も学会や試験会場としての実績はあるのですが、プログラミング言語を主体とした500人規模のカンファレンス開催の経験がなく、お互い手さぐりな状態ですすめることになりました。

そのため、メールのやり取りだけではだけでは足りず、細かい調整のため幾度も大学に伺い打ち合わせを行いました。

今まで大学側が想定していなかったネットワークや機器貸出や、PyCon開催が近づくにつれ見落としていたことや急な要望の変更で、総務課では対応しきれない要件や会場利用スケジュール変更も多くありましたが、

その都度、別窓口の紹介や調整と対応を行って頂き、概ね要望通りの会場利用をさせて頂きました。

PyCon各担当との調整では、主に事務局、スポンサー、映像配信、同時通訳、ランチの担当との調整になりました。

またボランティアスタッフだけでなく多くの業者等の関係者が携わっており、それらも各担当を窓口に調整が必要でした。

主な調整内容としては必要な備品の調整、当日の配置、荷物の受け取り、搬入出方法で、情報をまとめ、大学との調整を進めるものでした。

特に映像配信、同時通訳、ネットワークは、大学設置の機器を利用するため、機材調査のための下見日と実機材を持ち込んでの事前検証日を設定し準備を進めました。
...
参加者の見込みは500人程度ですが、最近はタブレット端末の併用などノートPCだけで繋ぎにくることはないと考え、一人平均1.5の端末と仮定して750セッション数という見積もりを予測を立てましたが、これはかなり大変なことになりそうだと直観的思いました。
...
全面的に情報システム部の方々からの協力も頂けることはわかりましたが、この時点で大学設置のAPだけでは収容しきるのは難しいと考え、追加機材によるAP増築案で進めることにしました。
機器の追加として、知り合いからWifi機材をかき集めて借りる、専門レンタル業者を利用する等を頭を抱えていたところ、たまたまRubyKaigiでの実績記事や知り合いからの紹介もあり、ヤマハとコンタクトをとることが出来ました。
当初は、機材貸出提供だけを考えていたのですが、ヤマハ技術担当の梶さんの提案により大学ネットワーク上にPyCon用の2日間専用のVPNを構築し運用するといった技術支援まで引き受けて頂くことになりました。
...
やってみた感想
--------------
PyConスタッフだけでなく大学関係者やヤマハ関係者等多くの方の協力を得て行うことが会場担当としての仕事が出来ました。この場を借りて、改めて御礼申し上げます。
